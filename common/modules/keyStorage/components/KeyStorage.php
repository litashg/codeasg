...
namespace common\modules\keyStorage\components;
...
/**
 * Class KeyStorage
 * @package \common\modules\keyStorage\components\keyStorage
 */
class KeyStorage extends Component
{
     ...
     * @var string
     */
    public $modelClass = '\common\modules\keyStorage\models\KeyStorageItem';
