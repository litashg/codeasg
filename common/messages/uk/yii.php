...
return [
    ...
    '{nFormatted} {n, plural, =1{kibibyte} other{kibibytes}}' => '{nFormatted} {n, plural, one{KiB} few{KiB} many{KiB} other{KiB}}',
    '{nFormatted} {n, plural, =1{kilobyte} other{kilobytes}}' => '{nFormatted} {n, plural, one{Kb} few{Kb} many{Kb} other{Kb}}',
    '{nFormatted} {n, plural, =1{mebibyte} other{mebibytes}}' => '{nFormatted} {n, plural, one{MiB} few{MiB} many{MiB} other{MiB}}',
    '{nFormatted} {n, plural, =1{megabyte} other{megabytes}}' => '{nFormatted} {n, plural, one{Mb} few{Mb} many{Mb} other{Mb}}',
